    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">اصحاب المطابع</li>
            </ol>
        </section>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 style="font-family: 'Cairo', sans-serif;" class="box-title">{{ 'جدول اصحاب المطابع' }}</h3>
                        </div>
                        ...
                        <div class="box-body">
                            ...
                            @else
                                <h1 style="font-family: 'Cairo', sans-serif;">للاسف لا يوجد اصحاب مشاريع حتي الان</h1>
                            @endif
                        </div>
                        <!-- /.box-body -->
                    </div>
