                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 style="font-family: 'Cairo', sans-serif;" class="box-title">{{ 'تعديل الملف الشخصي' }}</h3>
                        </div>
                    @include('common::partials._errors')
                        <!-- /.box-header -->
                        <div class="box-body">
                            <form action="{{ route('profile_update',$row->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                ...
                                <button type="submit" class="btn btn-primary"><i class="fa fa-edit"></i> تحديث الملف الشخصي</button>
                            </form>
                        </div>
                        <!-- /.box-body -->
                    </div>
