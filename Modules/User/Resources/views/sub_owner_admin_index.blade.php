    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">العاملين بالمطبعة</li>
            </ol>
        </section>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 style="font-family: 'Cairo', sans-serif;" class="box-title">{{ 'جدول العاملين بالمطبعة' }}</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            ...
                            @else
                                <h1 style="font-family: 'Cairo', sans-serif;">للاسف لا يوجد عاملين تم تعيينهم حتي الان</h1>
                            @endif
                        </div>
                    </div>
                </div>
