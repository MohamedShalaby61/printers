                    ...
                    <div class="col-lg-3 col-md-6 col-xs-12 mb-15">
                        <div class="card">
                          ...
                          <div class="card-body hvr-bubble-float-top">
                            ...
                            <p class="card-text">بعـد تسجيل الدخول إلى حسابك قم برفع الملف بصيغة pdf بأمان وخصوصية عالية.</p>
                          </div>
                        </div>
                    </div>
                     <div class="col-lg-3 col-md-6 col-xs-12 mb-15">
                        <div class="card">
                          ...
                          <div class="card-body hvr-bubble-float-top">
                            ...
                            <p class="card-text">مثل نوع الطباعة وحجم الورق ونوع التغليف مع اختيار آلية التوصيل.</p>
                          </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-xs-12 mb-15">
